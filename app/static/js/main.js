    ...
    const App = {
        state: {
            ...
            mappingFields: [
                ...
                'houseBank', 'bankGL', 'bankName', 'emailSender', 'emailSubject', 'zipPassword'
            ],
            displayFields: [
                { key: 'id', header: 'S No.' },
        ...
        handlers: {
            ...
            async pushToSAP() {
                ...
                // --- 1. START VISUAL CUE: Disable button and show spinner ---
                const btn = App.ui.pushSapBtn;
                ...
                try {
                    ...
                    // --- 2. STOP VISUAL CUE: Restore the button ---
                    if (btn) {
                        btn.disabled = false;
